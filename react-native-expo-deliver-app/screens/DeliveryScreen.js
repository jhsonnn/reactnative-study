  ...
  return (
    <View className='bg-[#00CCBB] flex-1'>
        ...
        <View className='z-50 p-6 mx-5 my-2 bg-white rounded-lg shadow-md'>
          <View className='flew-row justify-between'>
            <View>
              ...
              <Text className='text-3xl font-bold'>44-55분</Text>
            </View>
            <Image
      ...
      <SafeAreaView className='flex-row items-center space-x-5 bg-white h-28'>
        ...
        <TouchableOpacity className='flex-row items-center border-[#00CCBB] mr-5 px-4 py-2 rounded-lg'>
          <PhoneArrowUpRightIcon color='#00CCBB' size={25} />
          <Text className='text-[#00CCBB text-sm font-bold ml-2'>전화하기</Text>
        </TouchableOpacity>
      </SafeAreaView>
    </View>
  );
